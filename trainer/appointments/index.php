...
<head>
    ...
    <title>Trainer Section - Manage Appoinments</title>
    <style>
        .btn-danger {
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $row['ClientMobileNumber']; ?></td>
                                <td><?php echo $row['Groups']; ?></td>
                                <td><?php echo date('F j, Y', strtotime($row['AppoinmentDate'])); ?></td>
                                <td><a href="edit.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-rounded">Edit</a></td>
