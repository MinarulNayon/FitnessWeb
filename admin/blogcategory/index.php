...
<head>
    ...
    <title>Admin Section - Blog Category</title>
        ...
        <div class="admin-content">
            ...
            <div class="content">
                <div class="button-group">
                    <a href="create.php" class="btn btn-big">Add Blog Category</a>
                </div>

                <h2 class="page-title">Blog Category</h2>
